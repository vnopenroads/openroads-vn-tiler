...
## No need to conflate so not merging anymore. See below.
# gsplit --lines 1 $WORKDIR/network.geojson "$WORKDIR/network/"
# ../node_modules/.bin/geojson-merge $WORKDIR/network/* > $WORKDIR/network-merged.geojson
